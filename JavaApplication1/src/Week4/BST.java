...
/**
 * ****************************************************************************
 * Compilation: javac BST.java Execution: java BST Dependencies: StdIn.java
 * StdOut.java Queue.java Data files:
...
import org.graphstream.stream.file.gml.GMLParserConstants;
 ...
 * <em>rank</em> operations each take linear time in the worst case, if the tree
 * becomes unbalanced. The <em>size</em>, and <em>is-empty</em> operations take
...
//            this.level = ;
     ...
     */
    //2a. Voeg een attribuut int level toe aan de Node klasse van de boom en zorg ervoor dat elk Node in de boom een level waarde krijgt die overeenkomt met het "niveau" in de boom. De root heeft level 0. Gebruik de methode LevelOrder om dit voor elkaar te krijgen want die wandelt al per level door de boom heen.
    public static void main(String[] args) {

        BST<String, Integer> st = new BST<String, Integer>();
        In StdIn = new In("D:\\Users\\arnou\\Documents\\GitHub\\lag\\JavaApplication1\\src\\Week5\\graaf100.txt");
