  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        ...
        In StdIn = new In("D:\\Arnout\\documenten\\GitHub\\lag\\JavaApplication1\\src\\Week4\\dickens.txt");
        for (int i = 0; !StdIn.isEmpty(); i++) {
            String key = StdIn.readString();
            key = key.replaceAll("[^a-zA-Z ]", "").toLowerCase(); //remove punctuation and capital letters
            st.put(key, i);
        }
